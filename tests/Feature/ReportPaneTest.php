...
class ReportPaneTest extends AccountingTestCase
{
    ...
    public function test_every_report_in_the_hub_is_drawn_in_the_pane(): void
    {
        ...
        // five (reports-expansion-plan.md Phase 1.2) again with Support's two (Phase 1.3) again with Timesheets' two (1.4) Lifecycle's one (1.5) the loan book (1.6) the forward cash view (1.7) the payroll register (2.1) and leave liability (2.2) — a floor
        ...
        $this->assertGreaterThanOrEqual(32, count(Reports::catalogue()));
    }
