    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                /*
                 * The report's own filters, carried rather than asked for — item 1.
                 *
                 * A schedule stores "the same state the URL carries", and the hub's *Schedule* button fills
                 * this in from the report somebody was looking at: the account they picked, the month they
                 * filed. Hidden because there is nothing useful to type here — a filter belongs to the report
                 * and is chosen in the pane, where its options come from the report itself. In the form
                 * rather than read from the request at save time, because a Livewire submit is a different
                 * request from the one that carried the link.
                 */
                Hidden::make('state'),
            ]);
    }
