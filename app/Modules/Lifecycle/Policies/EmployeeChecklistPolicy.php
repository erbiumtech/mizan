...
class EmployeeChecklistPolicy
{
    ...
    public function view(User $user, EmployeeChecklist $record): bool
    {
        return $user->hasPermissionTo('ChecklistView');
    }
    ...
    public function update(User $user, EmployeeChecklist $record): bool
    {
        return $user->hasPermissionTo('ChecklistUpdate');
    }

    public function delete(User $user, EmployeeChecklist $record): bool
    {
