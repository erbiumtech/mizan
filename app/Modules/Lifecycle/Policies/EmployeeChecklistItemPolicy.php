 ...
 */
class EmployeeChecklistItemPolicy
{
    ...
    public function view(User $user, EmployeeChecklistItem $record): bool
    {
        return $user->hasPermissionTo('ChecklistView');
    }
    ...
    public function update(User $user, EmployeeChecklistItem $record): bool
    {
        return $user->hasPermissionTo('ChecklistUpdate');
    }

    public function delete(User $user, EmployeeChecklistItem $record): bool
    {
