...
class PersonalAccountPolicy
{
    ...
    public function view(User $user, PersonalAccount $record): bool
    {
        return $user->hasPermissionTo('PersonalFinanceView');
    }
    ...
    public function update(User $user, PersonalAccount $record): bool
    {
        return $user->hasPermissionTo('PersonalFinanceUpdate');
    }

    public function delete(User $user, PersonalAccount $record): bool
    {
