...
class LostReasonPolicy
{
    ...
    public function view(User $user, LostReason $record): bool
    {
        return $user->hasPermissionTo('PipelineView');
    }
    ...
    public function update(User $user, LostReason $record): bool
    {
        return $user->hasPermissionTo('PipelineUpdate');
    }

    public function delete(User $user, LostReason $record): bool
    {
