...
class CampaignSendPolicy
{
    ...
    public function view(User $user, CampaignSend $record): bool
    {
        return $user->hasPermissionTo('CampaignView');
    }
    ...
    public function update(User $user, CampaignSend $record): bool
    {
        return $user->hasPermissionTo('CampaignUpdate');
    }

    public function delete(User $user, CampaignSend $record): bool
    {
