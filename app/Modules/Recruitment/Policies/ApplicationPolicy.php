...
class ApplicationPolicy
{
    ...
    public function view(User $user, Application $record): bool
    {
        return $user->hasPermissionTo('ApplicantView');
    }
    ...
    public function update(User $user, Application $record): bool
    {
        return $user->hasPermissionTo('ApplicantUpdate');
    }

    public function delete(User $user, Application $record): bool
    {
